...
void voltageLoop(){
  ...
  if(millis() - lastLog > logPeriod){
    Serial.print(F("Voltage percent="));Serial.print(getVoltagePercent());
    Serial.print(F(",    Average current voltage="));Serial.print(getVoltage());
    Serial.print(F(",    Min voltage="));Serial.print(minVoltage);
    Serial.print(F(",    Max voltage="));Serial.print(maxVoltage);
    Serial.println();
    Serial.flush();
    lastLog = millis();
  }
