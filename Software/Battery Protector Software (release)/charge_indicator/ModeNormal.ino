...
void ledImmediate(int percent){
  if(percent > 100)//100
    ...
    led(GREEN,   GREEN,   GREEN,    BLACK);
  else if(percent > 60)//45
    led(GREEN,   GREEN,   GREEN,    BLACK);
  else if(percent > 50)//39
    led(GREEN,   GREEN,   BLACK,    BLACK);
  else if(percent > 35)//35
    led(MAGENTA,   MAGENTA,   BLACK,    BLACK);
  else if(percent > 20)//30
    led(MAGENTA,   BLACK,   BLACK,    BLACK);
  else if(percent > 0)
    led(MAGENTA,   BLACK,   BLACK,    BLACK);
  else if(percent <= 0)
    led(MAGENTA,   MAGENTA,   MAGENTA,    MAGENTA);
}
